...
class __TwigTemplate_d08e140e34539086e6b1968913aa5389d20b2e3c62be358af8045e17b6787d0d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/input/input--button--split.html.twig", "/Users/ben/Documents/Code/HB-Portfolio/themes/bootstrap/templates/input/input--button--split.html.twig");
    }
}
